...
class transaction():
    ...
    def to_needs(coin, id_p, id_c):
        ...
        coin_parents_all = c.execute("SELECT balance_parents FROM parents WHERE id_parent='{}'".format(id_p)).fetchall()
        ...
        c.execute("UPDATE parents SET balance_parents='{}'".format(coin_transaction_from_parents))
...
#transaction.bonus(10, 'fb4a1052-070a-4723-b8ec-fea66b7a1599', '9b6316b2-7598-4d7d-a681-6e6145b391ab')
